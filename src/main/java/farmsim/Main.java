...
public class Main {
    ...
    public static void runGame() throws Exception {
        ...
        System.out.println("The game will end when you reach $" + winningAmount + " or go bankrupt(reach $0)");
    ...
    public static void runDayTime() throws Exception {
        ...
        if (move.equals("buy sheep")) {
            ...
            for (Farmer farmer : farm.getFarmers()) {
                System.out.print("(" + i + ") " + farmer.getClass().getName().split("[.]")[1] + " Level: " + farmer.getLevel() + "    ");
                i++;
            }
            ...
            int i = 0;
            for (Animal animal : farm.getAnimals()) {
                System.out.print("(" + i + ") " + animal.getClass().getName().split("[.]")[1] + " Level: " + animal.getLevel() +  "   ");
                i++;
            }
    ...
    public static void runNightTime() {
        ...
        if (animalEaten < 10) {
            ...
            System.out.println(deadAnimal.getClass().getName().split("[.]")[1] + "(level " + deadAnimal.getLevel() + ") was eaten.\n");
        }
